...
"""
    ...
    def test_init_gitignore_keeps_runtime_private_and_definitions_trackable(self) -> None:
        ...
        private = (
            ...
            "chats/agent.json",
            "email-studio/mail.sqlite3",
            "email-studio/browser-profiles/account/Default/Cookies",
            "email-studio/managed-engine/settings.json",
            "email-kestra/workflows/private.yml",
            "pages/shared.json",
            "vault/lesson.md",
